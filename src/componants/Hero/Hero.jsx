...
const Hero = ({handleOrderPopup}) => {
    ...
    return (
        <div className='container p-8 pb-15'  >
            <div
                        ...
                        <div key={data.id}>
                            <div className='grid grid-cols-1 sm:grid-cols-2'>
                                ...
                                <div className='flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                                    ...
                                    <h1 className='text-5xl sm:text-6xl lg:text-7xl font-bold'>{data.title2}
                                    </h1>
                                    <h1 className='text-3xl uppercase text-white  dark:text-white/5  sm:text-[50] md:text-[80] xl:text-[100px]  font-bold p-4  '>{data.title2}</h1>
                                    <div>
