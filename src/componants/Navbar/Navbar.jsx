            ...
            <div className='py-4'>
                <div className="container flex justify-between item-center">
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        {/* Menu Item */}
                        <div className="hidden sm:block">   {/*hidden lg:block */}
                                   ...
                                   <ul className='space-y-2' >
                                        {
                                            DropdownLinks.map((data, index) => (
                                                <li>
                                                    <a
                                                    className='text-gray-500 dark:hover:text-white duration-200 inline-blok w-full p-2 hover:bg-primary/20 rounded-md font-semibold'
                    ...
                    <div className='flex justify-between items-center gap-4'>
                        ...
                        <div className='relative group hidden sm:block'>
                            <input type="text" placeholder='Search' className='search-bar' /><IoMdSearch className='text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 absolute top-1/2 -translate-y-1/2 right-3 duration-200  ' />
                        </div>
                        <div></div>
