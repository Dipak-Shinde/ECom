            ...
            <div className="container">
                <div className="grid md:grid-cols-3 pb-20 pt-5">
                    ...
                    <div className='py-8 px-4 '>
                        ...
                        <p className='text-gray-600 dark:text-white/70 lg:pr-24 pt-3'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ducimus eligendi deleniti totam provident dignissimos.</p>
                        <p className='text-gray-500 mt-4'>Made with ❤️ By the coding Journey</p>
                        <a href="#" target='_blank' className='inline-block bg-primary/90 text-white py-2 px-4 mt-4 text-sm rounded-full'>Visit Our Youtube Channel</a>
                    </div>
